...
export default function OperationsPage() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      ...
      default:
        return "bg-neutral-500/20 text-foreground"
    }
  }
          ...
          >
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div>
                  <CardTitle className="text-sm font-bold text-foreground tracking-wider">{operation.name}</CardTitle>
            ...
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2">OPERATION STATUS</h3>
                    <div className="flex gap-2">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2">MISSION DETAILS</h3>
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2">PROGRESS</h3>
                    <div className="space-y-2">
                  ...
                  <div>
                    <h3 className="text-sm font-medium text-foreground tracking-wider mb-2">OBJECTIVES</h3>
                    <div className="space-y-2">
              ...
              <div>
                <h3 className="text-sm font-medium text-foreground tracking-wider mb-2">DESCRIPTION</h3>
              ...
              <div className="flex gap-2 pt-4 border-t border-neutral-700">
                ...
                <Button
                  variant="outline"
                  className="border-neutral-700 text-neutral-400 hover:bg-neutral-800 hover:text-foreground bg-transparent"
                >
                  View Reports
                </Button>
                <Button
