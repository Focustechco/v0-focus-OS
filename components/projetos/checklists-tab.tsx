        ...
        <div className="flex items-start justify-between">
          <div className="min-w-0 flex-1 pr-2">
            <div className="flex items-center gap-2 mb-1">
              ...
              <Badge className={`${stageColor} text-white text-[9px] uppercase`}>
                {project.stage || "N/A"}
              </Badge>
            </div>
      ...
      <CardContent className="pt-4">
        <div className="space-y-2">
          {project.items.map((item: any) => (
            <div 
              key={item.id} 
              className="flex items-start gap-2 p-2 rounded-md hover:bg-[#1A1A1A] transition-colors group cursor-pointer"
  ...
  return (
    <div className="flex-1 w-full relative">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-xl font-display font-bold text-white">Checklists Operacionais</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {filteredProjects.length > 0 ? filteredProjects.map((project: any) => (
          ...
          <div className="col-span-full p-20 text-center border-2 border-dashed border-[#2A2A2A] rounded-xl">
